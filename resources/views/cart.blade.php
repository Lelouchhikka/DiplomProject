        ...
        <div class="row justify-content-center">
            ...
            @if(count($cartCollection)>0)
                <div class="col-lg-5">
                    ...
                    <br>
                    <a href="/" >
                        <x-button  class="bg-gray-100 text-sm">
                            {{__("Continue shopping")}}
                        </x-button>
                    </a>
                    @if(Auth::user()==null)

                        <x-button data-toggle="modal" data-target="#logModalCenter" class=" bg-blue-500 text-sm">
                            {{__("Login then pay")}}
                        </x-button>

                    @else
                        <a href="{{route('home')}}" >
                            <x-button  class="bg-red-600 text-sm">
                                {{__("Payment not available")}}
                            </x-button>
                        </a>
                    @endif
                </div>
